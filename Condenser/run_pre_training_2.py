...
from trainer_old import CondenserPreTrainer as Trainer
import transformers
...
def main():
    ...
    # train_set = train_set.rename_column("text", "model_input")
    ...
    #     dev_set = dev_set.rename_column("text", "model_input")
