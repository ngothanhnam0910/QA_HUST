...
if __name__ == '__main__':
    ...
    parser.add_argument("--pretrained_model", default="/mnt/md1/NAMNT_DA/ckp_sentencebert_2", type=str, help="path to your language model")
    parser.add_argument("--max_seq_length", default=256, type=int, help="maximum sequence length")
    parser.add_argument("--pair_data_path", type=str, default="/mnt/md1/NAMNT_DA/pair_data/save_pairs_finetuned_phobert_top20.pkl", help="path to saved pair data")
    parser.add_argument("--round", default=1, type=str, help="training round ")
    parser.add_argument("--num_val", default=500, type=int, help="number of eval data")
